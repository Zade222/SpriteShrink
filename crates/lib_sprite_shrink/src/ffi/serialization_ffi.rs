...
macro_rules! serialize_uncompressed_data_ffi_setter {
    (
        $doc_l11:literal,
        $fn_name:ident,
        ...
        pub unsafe extern "C" fn $fn_name(
            ...
            let (file_manifest, data_store) = unsafe {
                ...
                /*Reconstruct the file_manifest DashMap via the following and
                loop.*/
                let file_manifest: DashMap<String, 
                    FileManifestParent<$hash_type>> = DashMap::new();
            ...
            let mut entries: Vec<$ffi_chunk_index_entry> = chunk_index
                .into_iter()
                .map(|(hash, location)| {
...
serialize_uncompressed_data_ffi_setter!(
...
macro_rules! free_serialized_output_setter {
    (
        $doc_l2:literal,
        $doc_l12:literal,
        $fn_name:ident,
        ...
        pub unsafe extern "C" fn $fn_name(
            ...
            unsafe {
                ...
                let _ = Vec::from_raw_parts(
                    ...
                    output.ser_chunk_index_len);
                let _ = Vec::from_raw_parts(
                    output.sorted_hashes_ptr as *mut $hash_type, 
